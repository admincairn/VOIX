...
export type TestimonialSource = 'manual' | 'video' | 'google' | 'g2' | 'capterra' | 'trustpilot'
export type TestimonialStatus = 'pending' | 'published' | 'archived' | 'rejected'
...
export type WidgetType = 'carousel' | 'grid' | 'masonry' | 'single' | 'badge' | 'wall'
...
export interface EmbedData {
  ...
  testimonials: Pick<
    Testimonial,
    'id' | 'customer_name' | 'customer_title' | 'customer_avatar_url' | 'content' | 'video_url' | 'rating' | 'source' | 'featured'
  >[]
