// ============================================================
// VOIX — Sign Up Page
// Premium registration with social + email
// ============================================================
...
function SignUpForm() {
  ...
  const errorMessages: Record<string, string> = {
    OAuthSignin: "Erreur lors de l'inscription OAuth.",
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-white/40">
          Commencez à collecter des témoignages authentiques dès aujourd'hui.
        </p>
      </div>
      ...
      <AnimatePresence>
        {error && (
          ...
          >
            ...
            <div>
              <div className="font-medium mb-1">Erreur d'inscription</div>
      ...
      <AnimatePresence>
        {magicLinkSent && (
          ...
          >
            ...
            <div>
              <div className="font-medium mb-1">Vérifiez votre email</div>
              Un lien de connexion a été envoyé à {email}. Cliquez dessus pour
      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        {[
          ...
          <div key={feature} className="flex items-center gap-2 text-white/30">
